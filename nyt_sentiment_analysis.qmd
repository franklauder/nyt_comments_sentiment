...
## We'll first load the required libraries. 
<br/>
...
Now that our data is selected, we will prepare our data for analysis. First a function will be created to clean 
the text in the commentBody.  This will include removing HTML/Markdown tags, backslashes, and replacing multiple spaces with a single space. 
...
Observing sentiment within each news desk section,the Styles, Dining, Book Review, and Metropolitan sections are by have the highest percentage pf positive comments, all being over 60%.  The foreign section has the greatest percentage of negative comments at 50% with 17% of comments being neutral. 
